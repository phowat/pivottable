...
$.pivotUtilities.locales.pt = 
    ...
    aggregators:
        ...
        "Soma sobre Soma (Porcentagem)":                tpl.sumOverSum(frFmtPct)
        "Contagem de Valores &uacute;nicos sobre Soma":  tpl.countUniqueOverSum(frFmt)
        "Contagem de Valores &uacute;nicos sobre Soma (Porcentagem)": tpl.countUniqueOverSum(frFmtPct)
